...
import com.cowave.sys.code.api.mapper.*;
...
public class DbServiceImpl implements DbService {
    ...
    public void synTable(DbInfo dbInfo) throws Exception {
        Asserts.equals(0, tableMapper.countTableModels(dbInfo.getId()), "存在已绑定模型的表结构，不可以覆盖");
    ...
    private SqlSession getSqlSession(String driver, String url, String user, String passwd) throws Exception {
        ...
        Resource[] resources = new Resource[]{new ClassPathResource("com/cowave/sys/code/api/mapper/DbMapper.xml")};
