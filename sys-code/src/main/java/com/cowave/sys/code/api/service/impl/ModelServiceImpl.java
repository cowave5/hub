...
import com.cowave.sys.code.api.mapper.ModelMapper;
...
public class ModelServiceImpl implements ModelService {
    ...
    public void switchExcel(Long id, Integer flag) {
        modelMapper.switchExcel(id, flag, Access.accessUser());
    }

    @Override
    public void switchAccess(Long id, Integer flag) {
        modelMapper.switchAccess(id, flag, Access.accessUser());
    }

    @Override
    public void switchLog(Long id, Integer flag) {
        modelMapper.switchLog(id, flag, Access.accessUser());
    }
