  ...
  <div class="register">
    <el-form ref="form" :model="form" :rules="rules" class="register-form">
      ...
      <el-form-item prop="tenantId">
        <el-input v-model="form.tenantId" type="text" placeholder="公司">
...
export default {
  ...
  mounted() {
    localStorage.setItem('tenant_login_route', '/tenant/login');
  },
  created() {
...
.register-form {
  ...
  /* 为其整体设置接近透明的效果*/
  background-color: rgb(59 123 158 / 50%);
  position: relative;
  width: 350px;
...
.el-button--primary:hover {
  color: #FFFFFF;
  border-color: rgba(8, 72, 107, 0.5);
  background-color: rgba(21, 81, 114, 0.5);
}
</style>
