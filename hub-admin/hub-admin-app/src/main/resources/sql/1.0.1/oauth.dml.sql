...
INSERT INTO hub_oauth_app ("tenant_id", "client_name", "client_id", "client_secret", "grant_type", "auth_scope", "redirect_url", "create_by", "create_time", "update_by", "update_time")
VALUES ('cowave', 'sys-blog', '6ac6519451ed4ef09431aacccbcb1f5f', '4a2e671fbd074f238e80c7f5566f8f7a', '{authorization_code}', '{read_user}', 'http://10.64.4.74/auth/callback', NULL, '2022-04-25 09:00:00', NULL, '2022-04-25 09:00:00');
