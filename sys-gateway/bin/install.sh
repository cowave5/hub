...
sources(){
    ...
    ## info.application
    replace target/classes/config/application.yml version "$appVersion" 1
    replace target/classes/config/application.yml build "$buildTime" 1
    ## info.commit
    replace target/classes/config/application.yml version \""$codeVersion"\" 2
    replace target/classes/config/application.yml Msg \""$commit_msg"\" 1
    replace target/classes/config/application.yml Time "$commit_time" 1
    replace target/classes/config/application.yml Author "$commit_author" 1
}
