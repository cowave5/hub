...
#    replace $app_home/config/prod/application.yml name "$cluster_name" 1
...
#    ## redis
#    replace $app_home/config/prod/application.yml host "$redis_host" 1
#    replace $app_home/config/prod/application.yml port "$redis_port" 2
#    ## datasource
...
#    ## minio
#    replace $app_home/config/prod/application.yml endpoint "$minio_endpoint" 1
#    replace $app_home/config/prod/application.yml accessKey "$minio_accessKey" 1
#    replace $app_home/config/prod/application.yml secretKey "$minio_secretKey" 1
#    ## websocket
#    replace $app_home/config/prod/application.yml port "$socket_port" 3
#    ## Kafka
#    replace $app_home/config/prod/application-kafka.yml bootstrap-servers "$kafka_servers" 1
#    ## Nacos
#    replace $app_home/config/prod/application.yml server-addr "$nacos_server" 1
}
